...
class Deck:
    ...
    def __init__(self):
        ...
        self.allcards = [(s,r) for s in SUITE for r in RANKS ] #=> prepaire cards

    def shuffle(self):
        print("Shuffling Deck")
        shuffle(self.allcards) #=> shuffle cards

    def split_in_half(self):
        return (self.allcards[:26],self.allcards[26:])  #=> spli cards from 52 to 26
...
class Hand:
    ...
    def __str__(self):
        return "Contains {} cards".format(len(self.cards)) #=> report cards in the hand

    def add(self,added_cards):
        self.cards.extend(added_cards) #=> 

    def remove_card(self):
        return self.cards.pop() #=> remove top card or last card
